...
# Ma_et_al_2023_NHB_PM2.5_CVD_mort_US_I4R_replication_report.Rmd
...
# Read in PM2.5 and evironmental data | provided by authors
df1 <- read_csv("input/Data_2000-2016_county_monthly_combined.csv")

# Read in overall mortality data | retrieval attempt from CDC wonder
df2 <- rbind(
...
From this point forwards we used
...
-   ~~Works and generally appears similar but not as granular as the one in the paper...?~~
    ...
    -   ~~Also why does it go up in 2017?~~
        ...
        -   [~~https://lubridate.tidyverse.org/reference/as_date.html~~](https://lubridate.tidyverse.org/reference/as_date.html){.uri}
