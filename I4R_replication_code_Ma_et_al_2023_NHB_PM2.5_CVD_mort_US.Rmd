...
**Final version** (this present file - just a slightly cleaner display version): ***I4R_replication_code_Ma_et_al_2023_NHB_PM2.5_CVD_mort_US.Rmd***

*Previous version - replicationReportWorking.Rmd (used in report)*

### Data

see the [data_sourcing.md](https://github.com/samsiljee/PM2.5_CVD_mortality_US/blob/main/data_sourcing.md)
...
```{r fig_1a_rep, fig.height=8, fig.width=11, echo=TRUE}
...
```{r fig_1b_rep, fig.height=8, fig.width=11, echo=TRUE}
...
```{r sfig_2, fig.height=6, fig.width=11}
# Cut off at <5000
sfig_2 <- df4 %>%
...
```{r sfig_2.v2, fig.height=6, fig.width=11}
# Cut off at <50000
sfig_2.v2 <- df4 %>%
