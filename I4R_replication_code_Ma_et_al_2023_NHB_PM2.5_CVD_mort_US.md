...
**Final version** (this present file - just a slightly cleaner display
version):
***I4R_replication_code_Ma_et_al_2023_NHB_PM2.5_CVD_mort_US.Rmd***

*Previous version - replicationReportWorking.Rmd (used in report)*

### Data

see the
[data_sourcing.md](https://github.com/samsiljee/PM2.5_CVD_mortality_US/blob/main/data_sourcing.md)
